...
// time here. We can see that we are running concurrently that the uppercase runs before the
...
// -------------------------------
// Deadlock!
// All goroutines are asleep and yet we are waiting for waitGroup to get back to zero.
